...
var (
	...
	IssuePointIsUnavailableErrorMessage = "issue point is unavailable"
	OrderIsMovedMessage                 = "order is moved"
...
func IssuePointIsUnavailableError(err error) error {
	return wrapError(err, IssuePointIsUnavailableErrorMessage)
}
func OrderIsMovedMessageError(err error) error {
	return wrapError(err, OrderIsMovedMessage)
}
